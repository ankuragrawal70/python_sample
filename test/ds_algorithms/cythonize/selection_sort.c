...
{
    "distutils": {
        "name": "ds_algorithms.cythonize.selection_sort", 
        "sources": [
            "ds_algorithms/cythonize/selection_sort.pyx"
        ]
    }, 
    "module_name": "ds_algorithms.cythonize.selection_sort"
}
END: Cython Metadata */
...
#define __PYX_HAVE__ds_algorithms__cythonize__selection_sort
#define __PYX_HAVE_API__ds_algorithms__cythonize__selection_sort
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'ds_algorithms.cythonize.selection_sort' */
...
#define __Pyx_MODULE_NAME "ds_algorithms.cythonize.selection_sort"
extern int __pyx_module_is_main_ds_algorithms__cythonize__selection_sort;
int __pyx_module_is_main_ds_algorithms__cythonize__selection_sort = 0;

/* Implementation of 'ds_algorithms.cythonize.selection_sort' */
...
static const char __pyx_k_s_sort[] = "s_sort";
...
static const char __pyx_k_ds_algorithms_cythonize_selectio[] = "ds_algorithms/cythonize/selection_sort.pyx";
static const char __pyx_k_got_differing_extents_in_dimensi[] = "got differing extents in dimension %d (got %d and %d)";
static const char __pyx_k_no_default___reduce___due_to_non[] = "no default __reduce__ due to non-trivial __cinit__";
static const char __pyx_k_unable_to_allocate_shape_and_str[] = "unable to allocate shape and strides.";
static const char __pyx_k_ds_algorithms_cythonize_selectio_2[] = "ds_algorithms.cythonize.selection_sort";
...
static PyObject *__pyx_kp_s_ds_algorithms_cythonize_selectio;
static PyObject *__pyx_n_s_ds_algorithms_cythonize_selectio_2;
...
static PyObject *__pyx_n_s_s_sort;
...
static PyObject *__pyx_pf_13ds_algorithms_9cythonize_14selection_sort_selection_sort(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr); /* proto */
static PyObject *__pyx_pf_13ds_algorithms_9cythonize_14selection_sort_2s_sort(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x); /* proto */
...
/* "ds_algorithms/cythonize/selection_sort.pyx":6
 * #@wraparound(False)
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_13ds_algorithms_9cythonize_14selection_sort_1selection_sort(PyObject *__pyx_self, PyObject *__pyx_arg_arr); /*proto*/
static PyMethodDef __pyx_mdef_13ds_algorithms_9cythonize_14selection_sort_1selection_sort = {"selection_sort", (PyCFunction)__pyx_pw_13ds_algorithms_9cythonize_14selection_sort_1selection_sort, METH_O, 0};
static PyObject *__pyx_pw_13ds_algorithms_9cythonize_14selection_sort_1selection_sort(PyObject *__pyx_self, PyObject *__pyx_arg_arr) {
  __Pyx_memviewslice __pyx_v_arr = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("selection_sort (wrapper)", 0);
  assert(__pyx_arg_arr); {
    __pyx_v_arr = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_arg_arr, PyBUF_WRITABLE); if (unlikely(!__pyx_v_arr.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("ds_algorithms.cythonize.selection_sort.selection_sort", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13ds_algorithms_9cythonize_14selection_sort_selection_sort(__pyx_self, __pyx_v_arr);
...
static PyObject *__pyx_pf_13ds_algorithms_9cythonize_14selection_sort_selection_sort(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr) {
  int __pyx_v_i;
  ...
  /* "ds_algorithms/cythonize/selection_sort.pyx":10
 *     cdef int e
 *     cdef int min, flag, j
 *     cdef int le = len(arr)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "ds_algorithms/cythonize/selection_sort.pyx":11
 *     cdef int min, flag, j
 *     cdef int le = len(arr)
 *     for i in range(0, len(arr)):             # <<<<<<<<<<<<<<
 *         e = arr[i]
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "ds_algorithms/cythonize/selection_sort.pyx":12
 *     cdef int le = len(arr)
 *     for i in range(0, len(arr)):
 *         e = arr[i]             # <<<<<<<<<<<<<<
 *         min = arr[i]
 ...
 */
    ...
    __pyx_v_e = (*((int *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_4 * __pyx_v_arr.strides[0]) )));

    /* "ds_algorithms/cythonize/selection_sort.pyx":13
 *     for i in range(0, len(arr)):
 *         e = arr[i]
 *         min = arr[i]             # <<<<<<<<<<<<<<
 *         flag = 0
 ...
 */
    ...
    __pyx_v_min = (*((int *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_6 * __pyx_v_arr.strides[0]) )));

    /* "ds_algorithms/cythonize/selection_sort.pyx":14
 *         e = arr[i]
 *         min = arr[i]
 *         flag = 0             # <<<<<<<<<<<<<<
 *         j = i+1
 ...
 */
    ...
    /* "ds_algorithms/cythonize/selection_sort.pyx":15
 *         min = arr[i]
 *         flag = 0
 *         j = i+1             # <<<<<<<<<<<<<<
 *         for j in range(j, le):
 ...
 */
    ...
    /* "ds_algorithms/cythonize/selection_sort.pyx":16
 *         flag = 0
 *         j = i+1
 *         for j in range(j, le):             # <<<<<<<<<<<<<<
 *             if arr[j] < min:
 *                 min = arr[j]
 */
    __pyx_t_5 = __pyx_v_le;
    __pyx_t_7 = __pyx_t_5;
    for (__pyx_t_8 = __pyx_v_j; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
      __pyx_v_j = __pyx_t_8;

      /* "ds_algorithms/cythonize/selection_sort.pyx":17
 *         j = i+1
 *         for j in range(j, le):
 *             if arr[j] < min:             # <<<<<<<<<<<<<<
 *                 min = arr[j]
 ...
 */
      ...
      __pyx_t_11 = (((*((int *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_9 * __pyx_v_arr.strides[0]) ))) < __pyx_v_min) != 0);
      if (__pyx_t_11) {

        /* "ds_algorithms/cythonize/selection_sort.pyx":18
 *         for j in range(j, le):
 *             if arr[j] < min:
 *                 min = arr[j]             # <<<<<<<<<<<<<<
 *                 flag = 1
 ...
 */
        ...
        } else if (unlikely(__pyx_t_12 >= __pyx_v_arr.shape[0])) __pyx_t_10 = 0;
        if (unlikely(__pyx_t_10 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_10);
          __PYX_ERR(0, 18, __pyx_L1_error)
        }
        __pyx_v_min = (*((int *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_12 * __pyx_v_arr.strides[0]) )));

        /* "ds_algorithms/cythonize/selection_sort.pyx":19
 *             if arr[j] < min:
 *                 min = arr[j]
 *                 flag = 1             # <<<<<<<<<<<<<<
 *         if flag > 0:
 ...
 */
    ...
    /* "ds_algorithms/cythonize/selection_sort.pyx":20
 *                 min = arr[j]
 *                 flag = 1
 *         if flag > 0:             # <<<<<<<<<<<<<<
 *             flag = 0
 ...
 */
    ...
    if (__pyx_t_11) {
      ...
      /* "ds_algorithms/cythonize/selection_sort.pyx":21
 *                 flag = 1
 *         if flag > 0:
 *             flag = 0             # <<<<<<<<<<<<<<
 *             arr[i], arr[flag] = arr[flag], arr[i]
 ...
 */
      ...
      /* "ds_algorithms/cythonize/selection_sort.pyx":22
 *         if flag > 0:
 *             flag = 0
 *             arr[i], arr[flag] = arr[flag], arr[i]             # <<<<<<<<<<<<<<
 * 
 * 
 */
      __pyx_t_13 = __pyx_v_flag;
      __pyx_t_5 = -1;
      if (__pyx_t_13 < 0) {
        __pyx_t_13 += __pyx_v_arr.shape[0];
        if (unlikely(__pyx_t_13 < 0)) __pyx_t_5 = 0;
      } else if (unlikely(__pyx_t_13 >= __pyx_v_arr.shape[0])) __pyx_t_5 = 0;
      if (unlikely(__pyx_t_5 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_5);
        __PYX_ERR(0, 22, __pyx_L1_error)
      }
      __pyx_t_5 = (*((int *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_13 * __pyx_v_arr.strides[0]) )));
      __pyx_t_14 = __pyx_v_i;
      __pyx_t_7 = -1;
      if (__pyx_t_14 < 0) {
        __pyx_t_14 += __pyx_v_arr.shape[0];
        if (unlikely(__pyx_t_14 < 0)) __pyx_t_7 = 0;
      } else if (unlikely(__pyx_t_14 >= __pyx_v_arr.shape[0])) __pyx_t_7 = 0;
      if (unlikely(__pyx_t_7 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_7);
        __PYX_ERR(0, 22, __pyx_L1_error)
      }
      __pyx_t_7 = (*((int *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_14 * __pyx_v_arr.strides[0]) )));
      __pyx_t_15 = __pyx_v_i;
      __pyx_t_8 = -1;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_v_arr.shape[0];
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_8 = 0;
      } else if (unlikely(__pyx_t_15 >= __pyx_v_arr.shape[0])) __pyx_t_8 = 0;
      if (unlikely(__pyx_t_8 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_8);
        __PYX_ERR(0, 22, __pyx_L1_error)
      }
      *((int *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_15 * __pyx_v_arr.strides[0]) )) = __pyx_t_5;
      __pyx_t_16 = __pyx_v_flag;
      __pyx_t_5 = -1;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_v_arr.shape[0];
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_5 = 0;
      } else if (unlikely(__pyx_t_16 >= __pyx_v_arr.shape[0])) __pyx_t_5 = 0;
      if (unlikely(__pyx_t_5 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_5);
        __PYX_ERR(0, 22, __pyx_L1_error)
      }
      *((int *) ( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_16 * __pyx_v_arr.strides[0]) )) = __pyx_t_7;
...
/* "ds_algorithms/cythonize/selection_sort.pyx":27
 * 
 * 
 * def s_sort(int[:] x):             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_13ds_algorithms_9cythonize_14selection_sort_3s_sort(PyObject *__pyx_self, PyObject *__pyx_arg_x); /*proto*/
static PyMethodDef __pyx_mdef_13ds_algorithms_9cythonize_14selection_sort_3s_sort = {"s_sort", (PyCFunction)__pyx_pw_13ds_algorithms_9cythonize_14selection_sort_3s_sort, METH_O, 0};
static PyObject *__pyx_pw_13ds_algorithms_9cythonize_14selection_sort_3s_sort(PyObject *__pyx_self, PyObject *__pyx_arg_x) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("s_sort (wrapper)", 0);
  assert(__pyx_arg_x); {
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_arg_x, PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 27, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("ds_algorithms.cythonize.selection_sort.s_sort", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13ds_algorithms_9cythonize_14selection_sort_2s_sort(__pyx_self, __pyx_v_x);
...
static PyObject *__pyx_pf_13ds_algorithms_9cythonize_14selection_sort_2s_sort(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x) {
  ...
  __Pyx_RefNannySetupContext("s_sort", 0);

  /* "ds_algorithms/cythonize/selection_sort.pyx":28
 * 
 * def s_sort(int[:] x):
 *     for i in range(len(x)):             # <<<<<<<<<<<<<<
 *         swap = i + np.argmin(x[i:])
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_FromSize_t(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 28, __pyx_L1_error)
  ...
  for (;;) {
    ...
    /* "ds_algorithms/cythonize/selection_sort.pyx":29
 * def s_sort(int[:] x):
 *     for i in range(len(x)):
 *         swap = i + np.argmin(x[i:])             # <<<<<<<<<<<<<<
 *         (x[i], x[swap]) = (x[swap], x[i])
 ...
 */
    ...
    __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_argmin); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 29, __pyx_L1_error)
...
__pyx_t_6 = __pyx_memoryview_fromslice(__pyx_t_9, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 29, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    ...
    if (!__pyx_t_11) {
      __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_t_6); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 29, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_GOTREF(__pyx_t_3);
    } else {
      #if CYTHON_FAST_PYCALL
      ...
      #endif
      {
        ...
        __pyx_t_6 = 0;
        __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_12, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 29, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_7 = PyNumber_Add(__pyx_v_i, __pyx_t_3); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 29, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_XDECREF_SET(__pyx_v_swap, __pyx_t_7);
    __pyx_t_7 = 0;

    /* "ds_algorithms/cythonize/selection_sort.pyx":30
 *     for i in range(len(x)):
 *         swap = i + np.argmin(x[i:])
 *         (x[i], x[swap]) = (x[swap], x[i])             # <<<<<<<<<<<<<<
 *     #return x
 * 
 */
    __pyx_t_8 = __Pyx_PyIndex_AsSsize_t(__pyx_v_swap); if (unlikely((__pyx_t_8 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L1_error)
    __pyx_t_13 = __pyx_t_8;
    __pyx_t_10 = -1;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_v_x.shape[0];
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_13 >= __pyx_v_x.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 30, __pyx_L1_error)
    }
    __pyx_t_10 = (*((int *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_13 * __pyx_v_x.strides[0]) )));
    ...
    __pyx_t_15 = (*((int *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_14 * __pyx_v_x.strides[0]) )));
    __pyx_t_8 = __Pyx_PyIndex_AsSsize_t(__pyx_v_i); if (unlikely((__pyx_t_8 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L1_error)
    ...
    } else if (unlikely(__pyx_t_16 >= __pyx_v_x.shape[0])) __pyx_t_17 = 0;
    if (unlikely(__pyx_t_17 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_17);
      __PYX_ERR(0, 30, __pyx_L1_error)
    }
    *((int *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_16 * __pyx_v_x.strides[0]) )) = __pyx_t_10;
    __pyx_t_8 = __Pyx_PyIndex_AsSsize_t(__pyx_v_swap); if (unlikely((__pyx_t_8 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L1_error)
    ...
    } else if (unlikely(__pyx_t_18 >= __pyx_v_x.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 30, __pyx_L1_error)
    }
    *((int *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_18 * __pyx_v_x.strides[0]) )) = __pyx_t_15;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "ds_algorithms.cythonize.selection_sort.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "ds_algorithms.cythonize.selection_sort.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "ds_algorithms.cythonize.selection_sort.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "ds_algorithms.cythonize.selection_sort._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_ds_algorithms_cythonize_selectio, __pyx_k_ds_algorithms_cythonize_selectio, sizeof(__pyx_k_ds_algorithms_cythonize_selectio), 0, 0, 1, 0},
  {&__pyx_n_s_ds_algorithms_cythonize_selectio_2, __pyx_k_ds_algorithms_cythonize_selectio_2, sizeof(__pyx_k_ds_algorithms_cythonize_selectio_2), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_s_sort, __pyx_k_s_sort, sizeof(__pyx_k_s_sort), 0, 0, 1, 1},
 ...
 *     cdef int e
 */
  __pyx_tuple__22 = PyTuple_Pack(8, __pyx_n_s_arr, __pyx_n_s_arr, __pyx_n_s_i, __pyx_n_s_e, __pyx_n_s_min, __pyx_n_s_flag, __pyx_n_s_j, __pyx_n_s_le); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(1, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_ds_algorithms_cythonize_selectio, __pyx_n_s_selection_sort, 6, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 *         swap = i + np.argmin(x[i:])
 */
  __pyx_tuple__24 = PyTuple_Pack(4, __pyx_n_s_x, __pyx_n_s_x, __pyx_n_s_i, __pyx_n_s_swap); if (unlikely(!__pyx_tuple__24)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__24);
  __Pyx_GIVEREF(__pyx_tuple__24);
  __pyx_codeobj__25 = (PyObject*)__Pyx_PyCode_New(1, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__24, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_ds_algorithms_cythonize_selectio, __pyx_n_s_s_sort, 27, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__25)) __PYX_ERR(0, 27, __pyx_L1_error)
...
static int __pyx_pymod_exec_selection_sort(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_ds_algorithms__cythonize__selection_sort) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "ds_algorithms.cythonize.selection_sort")) {
      if (unlikely(PyDict_SetItemString(modules, "ds_algorithms.cythonize.selection_sort", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "ds_algorithms/cythonize/selection_sort.pyx":2
 ...
 *     cdef int e
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_13ds_algorithms_9cythonize_14selection_sort_1selection_sort, NULL, __pyx_n_s_ds_algorithms_cythonize_selectio_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_selection_sort, __pyx_t_1) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *         swap = i + np.argmin(x[i:])
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_13ds_algorithms_9cythonize_14selection_sort_3s_sort, NULL, __pyx_n_s_ds_algorithms_cythonize_selectio_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_s_sort, __pyx_t_1) < 0) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "ds_algorithms/cythonize/selection_sort.pyx":1
 * #from cython import boundscheck, wraparound             # <<<<<<<<<<<<<<
 * import numpy as np
 * #@boundscheck(False)
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init ds_algorithms.cythonize.selection_sort", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init ds_algorithms.cythonize.selection_sort");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
